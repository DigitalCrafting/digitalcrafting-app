...
export const ZoriaUISubroutesPathsEnum = {
    ...
    DATE_RANGE_PICKER_INPUT: 'date-range-picker',
    TIME_PICKER_INPUT: 'time-picker',
    TIME_RANGE_PICKER_INPUT: 'time-range-picker',
    DATE_TIME_PICKER_INPUT: 'date-time-picker',
    DATE_TIME_RANGE_PICKER_INPUT: 'date-time-range-picker',
    EMAIL_INPUT: 'email',
    INPUT: 'input',
    NUMBER_INPUT: 'number',
...
export const ZoriaUIDocsRoutes: Partial<Record<ZoriaUIRoutePathsEnum, string[]>> = {
    ...
    [ZoriaUIRoutePathsEnum.INPUTS]: [
        ...
        ZoriaUISubroutesPathsEnum.DATE_RANGE_PICKER_INPUT,
        ZoriaUISubroutesPathsEnum.TIME_PICKER_INPUT,
        ZoriaUISubroutesPathsEnum.TIME_RANGE_PICKER_INPUT,
        ZoriaUISubroutesPathsEnum.DATE_TIME_PICKER_INPUT,
        ZoriaUISubroutesPathsEnum.DATE_TIME_RANGE_PICKER_INPUT,
