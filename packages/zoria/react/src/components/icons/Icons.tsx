...
export const SvgIconBase = ({
    ...
    return (<svg
        ...
        aria-hidden="true"
        focusable={false}
        className={`z-icon ${sizeClassName} ${externalClassName}`.trim()}
    >
        {children}
    </svg>);
}

export const XIcon = (props: SvgIconBaseProps) => {
...
export const CalendarClockIcon = (props: SvgIconBaseProps) => {
    return <SvgIconBase {...props}>
...
export const CirclePlusIcon = (props: SvgIconBaseProps) => {
    return <SvgIconBase {...props}>
        <circle cx="12" cy="12" r="10"/>
        <path d="M8 12h8"/>
        <path d="M12 8v8"/>
...
export const CircleMinusIcon = (props: SvgIconBaseProps) => {
    return <SvgIconBase {...props}>
        <circle cx="12" cy="12" r="10"/>
        <path d="M8 12h8"/>
    </SvgIconBase>
...
export const PaletteIcon = (props: SvgIconBaseProps) => {
    return <SvgIconBase {...props}>
        <path
